...
import 'package:enginner_project/features/app/screens/shared_accounts/widgets/leave_shared_account_button_widget.dart';
        ...
        appBar: AppBar(
          ...
          actions: [
            sharedAccount.owner ==
                ...
                : LeaveSharedAccountButtonWidget(sharedAccount: sharedAccount)
          ],
        ),
                                      ...
                                      child: Dismissible(
                                        ...
                                        onDismissed: (direction) async {
                                          ...
                                          Snackbars.infoSnackbar(
                                              title: 'Usunięto!',
                                              message:
                                                  'Transakcja ${transaction.title} została poprawnie usunięta!');
                                        },
